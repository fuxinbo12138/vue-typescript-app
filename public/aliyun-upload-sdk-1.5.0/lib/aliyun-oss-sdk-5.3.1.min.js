  ...
  })()(
    {
          ...
          (function(r, n) {
            ...
            x(L, t("./object")),
              ...
              (L.authorization = function(t, e, r, n) {
                const i = C.buildCanonicalString(t.toUpperCase(), e, { headers: n, parameters: r });
              ...
              (L.createRequest = function(t) {
                ...
                const a = t.timeout || this.options.timeout;
                return {
                  url: i,
                  params: {
                    agent: this.agent,
      ...
      3: [
        function(t, e, r) {
          (function(e) {
            ...
            const o = t("babel-runtime/core-js/array/from"),
              a = n(o),
            ...
            (h.multipartUpload = c.default.mark(function t(e, r, n) {
              ...
              (h._resumeMultipart = c.default.mark(function t(e, r) {
                let n, i, o, s, u, l, p, f, h, m, v, b, y, g, _, w, x, E, S, T, k;
                return c.default.wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
            ...
            l.inherits(i, v),
              (i.prototype.readFileAndPush = function(t) {
                if (this.fileBuffer)
                  for (let e = !0; e && this.fileBuffer && this.start < this.fileBuffer.length; ) {
                    let r = this.start,
                      n = r + t;
      ...
      4: [
        function(t, e, r) {
          ...
          const i = t("babel-runtime/core-js/object/keys"),
            o = n(i),
          ...
          (function(e) {
            ...
            r.encodeCallback = function(t, r) {
              if (
                ...
                const n = { callbackUrl: encodeURI(r.callback.url), callbackBody: r.callback.body };
                r.callback.host && (n.callbackHost = r.callback.host),
                  r.callback.contentType && (n.callbackBodyType = r.callback.contentType);
                const i = new e((0, s.default)(n)).toString("base64");
      ...
      8: [
        function(t, e, r) {
          "use strict";
          const n = t("babel-runtime/regenerator"),
            i = (function(t) {
              return t && t.__esModule ? t : { default: t };
            })(n),
            o = t("copy-to"),
      ...
      9: [
        function(t, e, r) {
          (function(e) {
            ...
            const i = t("babel-runtime/core-js/json/stringify"),
              o = n(i),
            ...
            (r.buildCanonicalizedResource = function(t, e) {
              ...
              (r._signatureForURL = function(t, r, n, i) {
                ...
                if (
                  (r.response &&
                    (0, s.default)(r.response).forEach(function(t) {
                      const e = "response-" + t.toLowerCase();
                      c[e] = r.response[t];
                    }),
                ...
                const p = this.buildCanonicalString(
                  r.method,
                  n,
      ...
      11: [
        function(t, e, r) {
          "use strict";
          r._isIP = function(t) {
            const e = /^(25[0-5]|2[0-4]\d|[0-1]?\d?\d)(\.(25[0-5]|2[0-4]\d|[0-1]?\d?\d)){3}$/,
      ...
      31: [
        function(t, e, r) {
          "use strict";
          r.__esModule = !0;
          const n = t("../core-js/object/define-property"),
            i = (function(t) {
              return t && t.__esModule ? t : { default: t };
            })(n);
          r.default = (function() {
      ...
      32: [
        function(t, e, r) {
          ...
          r.__esModule = !0;
          const i = t("../core-js/symbol/iterator"),
            o = n(i),
            a = t("../core-js/symbol"),
            s = n(a),
            c =
            ...
            (o.prototype.slice = function(t, e) {
              ...
              (o.prototype.fill = function(t, e, r, n) {
                ...
                if ("number" == typeof t) for (a = e; a < r; ++a) this[a] = t;
                  ...
                  const s = o.isBuffer(t) ? t : z(new o(t, n).toString()),
                    c = s.length;
          ...
          (e.exports = n),
            ...
            (n.prototype.to = function(t) {
              ...
              for (var r = 0; r < e.length; r++) {
                var n = e[r];
                if (i(t, n)) {
                  const o = this.src.__lookupGetter__(n),
            ...
            (n.prototype.toCover = function(t) {
              for (let e = this.keys || Object.keys(this.src), r = 0; r < e.length; r++) {
                const n = e[r];
                delete t[n];
                const i = this.src.__lookupGetter__(n),
      ...
      102: [
        function(t, e, r) {
          const n = t("./_object-keys-internal"),
      ...
      114: [
        function(t, e, r) {
          ...
          const n = t("./_global"),
            ...
            s = t("./_wks")("species");
          e.exports = function(t) {
            const e = "function" == typeof i[t] ? i[t] : n[t];
            a &&
              e &&
              !e[s] &&
              o.f(e, s, {
      ...
      146: [
        function(t, e, r) {
          ...
          for (
            let tt = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(
                ","
              ),
              et = 0;
            tt.length > et;
      ...
      154: [
        function(e, r, n) {
          "use strict";
          const i = e("babel-runtime/helpers/typeof"),
            o = (function(t) {
              return t && t.__esModule ? t : { default: t };
            })(i);
          !(function(e) {
            ...
            var u = (function() {
              const t = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZWN]|'[^']*'|'[^']*'/g,
      ...
      156: [
        function(t, e, r) {
          ...
          function o(t) {
            ...
            for (
              let e = ("string" == typeof t ? t : "").split(/[\s,]+/), n = e.length, i = 0;
              i < n;
              i++
            )
              e[i] &&
        ...
        function(e, r, n) {
          (function(e) {
            (function() {
              ...
              function l(t, e) {
                const r = null != t ? typeof t[e] : "number";
                return !(
        ...
        function(e, r, n) {
          (function(e) {
            !(function(i) {
              ...
              const b = "object" == typeof n && n && !n.nodeType && n,
          ...
          (function(r, n) {
            ...
            (c.prototype.read = function(t) {
              ...
              (c.prototype.pipe = function(t, e) {
                ...
                const h = (!e || !1 !== e.end) && t !== r.stdout && t !== r.stderr,
                  m = h ? i : p;
              ...
              (c.prototype.wrap = function(t) {
                ...
                for (let o = 0; o < Y.length; o++) t.on(Y[o], this.emit.bind(this, Y[o]));
                return (
          ...
          (e.exports = (function() {
            ...
            a &&
              ...
              (e.exports.prototype[a.inspect.custom] = function() {
                const t = a.inspect({ length: this.length });
      ...
      192: [
        function(t, e, r) {
          !(function(t) {
            "use strict";
            function r(t, e, r, n) {
              const o = e && e.prototype instanceof i ? e : i,
            ...
            const I = (a.prototype = i.prototype = Object.create(N));
      ...
      194: [
        function(t, e, r) {
          (function(e) {
            ...
            const i = t("babel-runtime/core-js/string/from-code-point"),
              o = n(i),
              a = t("babel-runtime/core-js/json/stringify"),
              s = n(a),
            ...
            !(function(r) {
              ...
              function a(t) {
                for (let e = 0, r = D.length; e < r; e++) t[D[e]] = "";
              }
              function c(t) {
                x(t),
              ...
              function j(t) {
                ...
                const e = t.tags[t.tags.length - 1] || t,
        ...
        function(t, e, r) {
          (function(e) {
            ...
            (c.request = function(t, r) {
              ...
              let i = -1 === e.location.protocol.search(/^https?:$/) ? "http:" : "",
                a = t.protocol || i,
                c = t.hostname || t.host,
                u = t.port,
                l = t.path || "/";
      ...
      199: [
        function(t, e, r) {
          (function(e, n, i) {
            "use strict";
            const o = t("babel-runtime/core-js/promise"),
              a = (function(t) {
                return t && t.__esModule ? t : { default: t };
              })(o),
              s = t("./capability"),
              ...
              p = (r.IncomingMessage = function(t, r, o, c) {
                ...
                if (
                  ...
                  if (
                    ...
                    const d = l.rawHeaders["mime-type"];
                    if (d) {
                      const h = d.match(/;\s*charset=([^;])(;|$)/);
      ...
      201: [
        function(t, e, r) {
          (function(e, n) {
            ...
            let o = t("process/browser.js").nextTick,
            ...
            (r.debuglog = function(t) {
              if ((w(I) && (I = e.env.NODE_DEBUG || ""), (t = t.toUpperCase()), !L[t]))
                if (new RegExp("\\b" + t + "\\b", "i").test(I)) {
                  const n = e.pid;
                  L[t] = function() {
                    const e = r.format.apply(r, arguments);
      ...
      209: [
        function(t, e, r) {
          ...
          const i = t("babel-runtime/helpers/typeof"),
            o = n(i),
            a = t("babel-runtime/core-js/object/keys"),
            s = n(a);
          (function() {
      ...
      211: [
        function(t, e, r) {
          ...
          const i = t("babel-runtime/core-js/object/get-own-property-names"),
            o = n(i),
            a = t("babel-runtime/core-js/object/keys"),
            s = n(a),
            c = t("babel-runtime/helpers/typeof"),
      ...
      214: [
        function(t, e, r) {
          ...
          const i = t("babel-runtime/core-js/object/get-prototype-of"),
            o = n(i),
      ...
      215: [
        function(t, e, r) {
          "use strict";
          const n = t("babel-runtime/core-js/object/create"),
            i = (function(t) {
              return t && t.__esModule ? t : { default: t };
            })(n);
          (function() {
      ...
      242: [
        function(e, r, n) {
          (function(i) {
            ...
            const a = e("babel-runtime/core-js/object/create"),
              s = o(a),
                    ...
                    ? (function() {
                        v("Connect timer ticking, timeout: %d", at),
                          (V = setTimeout(function() {
                            (V = null), -1 === tt && (tt = -2);
                            let t = "Connect timeout for " + at + "ms",
