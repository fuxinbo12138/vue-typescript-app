            ...
            f = (o.BufferedBlockAlgorithm = i.extend({
              ...
              _process: function(t) {
                ...
                const c = u * i,
                  l = e.min(4 * c, o);
                if (c) {
                  for (let f = 0; f < c; f += i) this._doProcessBlock(r, f);
                  var h = r.splice(0, c);
                  n.sigBytes -= l;
                }
      ...
      return (
        (function(t) {
          ...
          const a = e,
            ...
            f = [];
          !(function() {
            for (let e = 0; e < 64; e++) f[e] = (4294967296 * t.abs(t.sin(e + 1))) | 0;
          })();
          const h = (l.MD5 = c.extend({
            _doReset: function() {
            ...
            [
              {
                key: "getUuid",
                value: function() {
                  let e = c.default.get("p_h5_upload_u");
            ...
            i(e, [
              ...
              },
              {
                ...
                value: function(e, t, n, r, o, i) {
                  ...
                  for (let s = (this.options, 0); s < this._uploadList.length; s++)
                    ...
                    I.default.getMd5(e, function(e) {
                      ...
                      c.options.localCheckpoint ||
                        ...
                        c._getCheckoutpointFromCloud(
                          ...
                          function(e) {
                            if (e.UploadPoint) {
                              const t = JSON.parse(e.UploadPoint);
                              1 != t.loaded &&
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  const t = this._uploadList[this._curIndex];
              ...
              },
              {
                ...
                value: function() {
                  if (
                    ...
                    const e = this._uploadList[this._curIndex];
              ...
              },
              {
                ...
                value: function(e) {
                  const t = this;
                  if (!e) return !1;
                  const n = JSON.parse(f.default.decode(e));
                  return (
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  ...
                  if (this._uploadList.length > this._curIndex) {
                    const r = this._uploadList[this._curIndex];
                    r.object
              ...
              },
              {
                ...
                value: function(e, t, n, r) {
                  if (!e || !t || !n) return !1;
                  const o = JSON.parse(f.default.decode(t));
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  if (((e.retry = t), n.onUploadstarted && !t))
                    try {
                      const r = this._getCheckoutpoint(e);
                      r &&
              ...
              },
              {
                ...
                value: function(e) {
                  ...
                  let n = y.default.getFileType(e.file.name),
                  ...
                  const s = this._adjustPartSize(e);
              ...
              },
              {
                ...
                value: function(e) {
                  const t = this._getCheckoutpointKey(e);
                  d.default.remove(t);
                }
              },
              {
              ...
              },
              {
                ...
                value: function(e, t, n) {
                  if (t) {
                    const r = this._getCheckoutpointKey(e),
                      o = e.file,
                      i = {
                        fileName: o.name,
              ...
              },
              {
                key: "_changeState",
                value: function(e, t) {
                  const n = this._getCheckoutpoint(e);
                  n &&
                  ...
                  window &&
                    (window.onbeforeunload = function(t) {
                      if (
                        ...
                        const n = e._uploadList[e._curIndex];
              ...
              },
              {
                key: "_initState",
                value: function() {
                  for (let e = 0; e < this._uploadList.length; e++) {
                    const t = this._uploadList[e];
    ...
    (function(e) {
      ...
      (i.prototype.slice = function(e, t) {
        ...
        if (i.TYPED_ARRAY_SUPPORT) (r = this.subarray(e, t)), (r.__proto__ = i.prototype);
          ...
          const o = t - e;
          r = new i(o, void 0);
          for (let a = 0; a < o; ++a) r[a] = this[a + e];
        }
        return r;
      }),
        ...
        (i.prototype.fill = function(e, t, n, r) {
          ...
          if ("number" == typeof e) for (a = t; a < n; ++a) this[a] = e;
            ...
            const s = i.isBuffer(e) ? e : H(new i(e, r).toString()),
              u = s.length;
          ...
          o(e, null, [
            {
              key: "get",
              value: function(e) {
                for (let t = e + "", n = document.cookie.split(";"), r = 0; r < n.length; r++) {
                  const o = n[r].trim();
          ...
          i(e, null, [
            {
              ...
              value: function(e, t, n) {
                const r = (c.default.randomUUID(), c.default.randomUUID()),
                  o = {
                    AccessKeyId: e.accessKeyId,
            ...
            },
            {
              ...
              value: function(e, t, n) {
                ...
                s.default.get(
                  ...
                  function(e) {
                    if (n) {
                      let t = { Code: "GetUploadAuthFailed", Message: "获取uploadauth失败" };
                      try {
                        t = JSON.parse(e);
                      } catch (e) {}
                      n(t);
              ...
              _doProcessBlock: function(e, t) {
                for (
                  ...
                  if (c < 16) a[c] = 0 | e[t + c];
                    ...
                    const l = a[c - 3] ^ a[c - 8] ^ a[c - 14] ^ a[c - 16];
                    a[c] = (l << 1) | (l >>> 31);
                  }
                  let f = ((r << 5) | (r >>> 27)) + u + a[c];
                  (f +=
                    c < 20
                      ? 1518500249 + ((o & i) | (~o & s))
                      : c < 40
        ...
        (function() {
          function t(e, t, n) {
            for (var r = [], i = 0, a = 0; a < t; a++)
              if (a % 4) {
                const s = n[e.charCodeAt(a - 1)] << ((a % 4) * 2),
          ...
          i.Base64 = {
            ...
            parse: function(e) {
              ...
              if (!o) {
                o = this._reverseMap = [];
                for (let i = 0; i < r.length; i++) o[r.charCodeAt(i)] = i;
              }
              const a = r.charAt(64);
              if (a) {
                const s = e.indexOf(a);
        ...
        return (
          i(e, null, [
            ...
            },
            {
              key: "get",
              value: function(t, n, r) {
                const o = g.default.ISODateString(new Date()),
                  i = Math.floor(new Date().valueOf() / 1e3),
                  a = f.default.getClientId(),
            ...
            o(e, null, [
              {
                ...
                value: function(e, t, n) {
                  ...
                  (r.onload = function(e) {
                    try {
                      if (e && e.target) {
                        const n = i(a.parse(e.target.result)),
                          r = n.toString();
                        t(r);
                      }
                    } catch (e) {
